...
func TestStrictResolver_WithDefault(t *testing.T) {
	...
	if defaultResolver == nil {
		t.Fatal("want default resolver to be created")
	}

	if defaultResolver.Default() != defaultDef {
		t.Errorf("want default definition to be set correctly, got %v", defaultResolver.Default())
	}
}
